...
The itwinai plug-in is developed to provide use-case stakeholders with an opportunity
to modify the integration code if needed. It was adapted directly from the use-case folder
in the main itwinai repository. 
